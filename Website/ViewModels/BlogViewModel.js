            ...
            BlogViewModel.prototype.loadData = function () {
                ...
                this._dataService.getRecentWordPressPosts().then(function (posts) {
                    if (_this.itemsSource == null)
                        _this.itemsSource = new WinJS.Binding.List(posts).createSorted(function (left, right) {
                            return (left.post.date > right.post.date ? -1 : +1);
                        });
                    else {
                        posts.forEach(function (v1, i1, a1) {
                            var found = false;
                            _this.itemsSource.some(function (v, i, a) {
